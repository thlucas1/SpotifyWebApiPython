...
try:
    ...
    print('\nGetting page of browse categories ...\n')
    pageObj:CategoryPage = spotify.GetBrowseCategorysPage()
    ...
    while True:
        ...
        if pageObj.Next is None:
            ...
            pageObj = spotify.GetBrowseCategorysPage(offset=pageObj.Offset + pageObj.Limit, limit=pageObj.Limit)
