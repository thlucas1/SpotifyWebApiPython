...
try:
    ...
    print('secure token processing for Spotify Connect devices that utilize OAuth2')
    print('authorization tokens.')
    print('')
    ...
    print('** Token Cache file located on your Home Assistant server.')
