...
try:
    ...
    # This variable contains the relative directory path of the Token Cache File.
    # This directory will be created by the process, and will contain the Token Cache
    # file that contains the token(s) that are generated by this process.  Once you
    # have finished running the script, you will then copy this file to your Home
    # Assistant server config folder that contains the SpotifyPlus integration:
    # `./config/custom_components/spotifyplus/data`.
    tokenStorageDir:str = './spotifyplus_tokendata'
