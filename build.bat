...
set PYTHONPATH=C:\Users\thluc\source\repos\SpotifyWebApiPythonProject;C:\Users\thluc\source\repos\SpotifyWebApiPythonProject\spotifywebapipython
...
python -m twine upload --verbose --repository testpypi ./dist/*%BUILDENV_PACKAGEVERSION%*
