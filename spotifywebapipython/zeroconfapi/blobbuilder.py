...
from .helpers import write_bytes, write_int, byte_list_to_int, b64_to_int, int_to_bytes


class BlobBuilder:
    
    def __init__(self, credentials: Credentials, device_id: str, remote_pubkey: str):
