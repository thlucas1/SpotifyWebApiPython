...
@export
class SpotifyZeroconfApiError(Exception):
    """
    Exception thrown when a Spotify ZeroConf API Request Error occurs.
    """
    ...
    def ToString(self) -> str:
        ...
        """
        msg:str = SAAppMessages.MSG_SPOTIFY_ZEROCONF_API_ERROR.format(
