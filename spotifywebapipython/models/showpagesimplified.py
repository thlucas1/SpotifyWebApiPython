...
@export
class ShowPageSimplified(PageObject):
    """
    Spotify Web API SimplifiedShowPage object.
    
    This allows for multiple pages of `ShowSimplified` objects to be navigated.
    """
    ...
    def __init__(self, root:dict=None) -> None:
        ...
        # initialize storage.
        self._Items:list[ShowSimplified] = []
    ...
    @property
    def Items(self) -> list[ShowSimplified]:
        """ 
        Array of `ShowSimplified` objects.
        """
        return self._Items
    ...
    def ToString(self, includeItems:bool=False) -> str:
        ...
        """
        return 'ShowPageSimplified: %s' % super().ToString(includeItems)
