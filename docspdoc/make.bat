...
echo.
pdoc -o ..\docspdoc\build -d google --no-show-source --no-math --no-mermaid --search -t ..\docspdoc\templates\darkmode __init__ models/album.py models/albumpagesaved.py models/albumpagesimplified.py models/albumsaved.py models/albumsimplified.py models/artist.py models/artistpage.py models/artistsimplified.py models/audiobook.py models/audiobookpagesimplified.py models/audiobooksimplified.py models/audiofeatures.py models/author.py models/category.py models/categorypage.py models/chapter.py models/chapterpagesimplified.py models/chaptersimplified.py models/context.py models/copyright.py models/device.py models/episode.py models/episodepagesaved.py models/episodepagesimplified.py models/episodesaved.py models/episodesimplified.py models/explicitcontent.py models/externalids.py models/externalurls.py models/followers.py models/imageobject.py models/narrator.py models/owner.py models/pageobject.py models/playeractions.py models/playerplaystate.py models/playerqueueinfo.py models/playhistory.py models/playhistorypage.py models/playlist.py models/playlistpage.py models/playlistpagesimplified.py models/playlistsimplified.py models/playlisttrack.py models/playlisttracksummary.py models/recommendationseed.py models/restrictions.py models/resumepoint.py models/searchresponse.py models/show.py models/showpagesaved.py models/showpagesimplified.py models/showsaved.py models/showsimplified.py models/track.py models/trackpage.py models/trackpagesaved.py models/trackpagesimplified.py models/tracksaved.py models/tracksimplified.py models/trackrecommendations.py models/userprofile.py models/userprofilesimplified.py oauthcli/authclient.py zeroconfapi/spotifyzeroconfapierror.py zeroconfapi/zeroconfconnect.py zeroconfapi/zeroconfgetinfo.py zeroconfapi/zeroconfgetinfoalias.py zeroconfapi/zeroconfgetinfodrmmediaformat.py zeroconfapi/zeroconfresponse.py const.py saappmessages.py sautils.py spotifyapierror.py spotifyapimessage.py spotifyauthtoken.py spotifyclient.py spotifydiscovery.py spotifywebapiauthenticationerror.py spotifywebapierror.py
